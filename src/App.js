...
const App = () => {
  ...
  const startAltitudeChange = (e) => {
    ...
    const { distance, estimated, verticalSpeed, errors } = calculateDistance({
    ...
    <>
      ...
      <Container>
        ...
        <BoxAdvert>
          <p>
            <span style={{ fontSize: "18px" }}>
              <span style={{ fontSize: "22px" }}>&#9733;</span> Check the runway
              calculator:
            </span>{" "}
            <a
              href="https://runway.airportdb.io"
              target="_blank"
        ...
        <Box>
          ...
          <Hint>
            These calculations are not strictly accurate. It strongly depends on
            aircraft type and weather. Use it for approximate decision
          </Hint>
          <div className="row">
            <div className="col-md-6 form-group">
              <label htmlFor="startAltitude">Start altitude (ft)</label>
              <Cleave
                id="startAltitude"
                className={errors["startAltitude"] ? "invalid" : ""}
                placeholder="30 000"
            ...
            <div className="col-md-6 form-group">
              <label htmlFor="endAltitude">End altitude (ft)</label>
              <Cleave
                id="endAltitude"
                className={errors["endAltitude"] ? "invalid" : ""}
                placeholder="10 000"
            ...
            <div className="col-sm-6 col-md-4 form-group">
              <label htmlFor="startSpeed">Start speed (kts)</label>
              <Cleave
                id="startSpeed"
                className={errors["startSpeed"] ? "invalid" : ""}
                placeholder="320"
            ...
            <div className="col-sm-6 form-group">
              ...
              <Cleave
                id="glideSlope"
                className={errors["glideSlope"] ? "invalid" : ""}
                placeholder="3"
            ...
            <div className="col-md-6 form-group">
              <label htmlFor="verticalSpeed">Vertical Speed (fpm)</label>
              <Cleave
                id="verticalSpeed"
                className={errors["verticalSpeed"] ? "invalid" : ""}
                placeholder="1 500"
